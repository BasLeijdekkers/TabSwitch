...
final class AriadnaFileTypeWrapper extends FileTypeWrapper {
    ...
    static {
        final Method result;
        try {
            result = FileType.class.getMethod("getIcon", null);
    ...
    AriadnaFileTypeWrapper(FileType fileType) {
        super(fileType);
    }
    ...
    Icon directGetIcon(FileType fileType) {
        final Object result;
        try {
            result = GET_ICON_METHOD.invoke(fileType, (Object[])null);
